...
omar.save
omar_flat = Flat.new(name: "Lebanon Palace", description: "Nice Place", location: "Lebanon", price: 200)
omar_flat.user = omar
omar_flat.save
p "omar_flat.save"
p omar_flat.save
...
sergio.save
sergio_flat = Flat.new(name: "Portugal Villa", description: "Huge House", location: "Portugal", price: 200)
...
ollie.save
ollie_flat = Flat.new(name: "Amsterdam Apartment", description: "Nice View", location: "Amsterdam", price: 200)
...
dan.save
dan_flat = Flat.new(name: "Ireland House", description: "Nice View", location: "Ireland", price: 200)
dan_flat.user = dan
dan_flat.save
p "dan_flat.save"
p dan_flat.save
